    ...
    render() {
        return (<SafeAreaView style={commonStyle.safeView}>
            <ScrollView style={{ width: '100%', height: '100%' }} contentContainerStyle={commonStyle.scrollViewContainer}>
                <View style={{ flexDirection: 'row', paddingTop: scaleSize(20), paddingBottom: scaleSize(40) }}>
                    <Text style={{ fontSize: scaleSize(26), fontWeight: 'bold', color: '#000' }}>*请使用您收到的邮件中的验证码完成激活</Text>
                </View>
